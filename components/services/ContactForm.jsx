      ...
      <dialog id="my_modal_1" className="modal">
        <div className="modal-box bg-neutral-900 flex justify-center items-center w-[40%] h-auto max-w-none sc">
          <div className='flex flex-col w-full'>
            ...
            <form method="dialog">
              <button className="font-light text-[1.1rem] pb-14 cursor-pointer text-white">CLOSE</button>
            </form>

            <div>
              <h2 className='text-4xl font-bold pb-7 text-white'>Go embedded!</h2>
            </div>
            <div className='flex pb-7 gap-10'>
              <ul className="w-auto space-y-3">
                <li className="flex items-center gap-2 font-sans text-white">
                  <img src="/images/CheckIcon.svg" alt="Check icon" className="w-8 h-8" />
            ...
            <div className="modal-action flex justify-center items-center p-5  w-full">
              <form className="space-y-6 flex flex-col gap-5 w-full p-5" method="dialog">
