...
export default function ServiceSectionRight({ className }) {
  return (
    <section
      className={`container flex flex-col md:flex-row-reverse justify-center items-center gap-10 py-16"${className}"`}
    >
      {/* Image Section */}
      <motion.div
        ...
        viewport={{ once: true }}
        className="flex-1 overflow-hidden flex justify-end items-center"
      >
        <div
          className={`${styles.clip_img} sm:clip-img clip-img bg-cover bg-center bg-no-repeat w-[500px] h-[600px] rounded-lg`}
        />
      </motion.div>
