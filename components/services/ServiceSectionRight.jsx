...
export default function ServiceSectionRight({ component }) {
  return (
    <section className="container mx-auto px-4 sm:px-8 md:px-12 lg:px-20 flex flex-col md:flex-row-reverse items-center gap-10 py-16">
      {/* Image Section */}
      <motion.div
        ...
        viewport={{ once: true }}
        className="flex-1 overflow-hidden flex justify-center md:justify-end items-center w-full"
      >
        <div
