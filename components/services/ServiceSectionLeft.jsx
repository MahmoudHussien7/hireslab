...
export default function ServiceSectionLeft({ component }) {
    return (
        <section className={`container mx-auto px-4 md:px-12 lg:px-20 flex flex-col md:flex-row items-center gap-10 py-16`}>
          {/* Image Section */}
          <div className="flex-1 overflow-hidden flex justify-start items-center">
